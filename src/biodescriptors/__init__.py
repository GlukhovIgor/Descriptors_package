...
The structure of the package and detailed description of each function can be found in the current documentation 
(all the modules listed in the left part of this page). Currently our package contains only one module named `calc`.
